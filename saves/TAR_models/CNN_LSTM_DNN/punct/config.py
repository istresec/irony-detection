...
# Test configuration
path_punctuation = "/saves/TAR_models/CNN_LSTM_DNN/punct/best_model.pth"  # path to model with punctuation
path_no_punctuation = "C:/Users/Jelena/git_repos/irony-detection/saves/TAR_models/CNN_LSTM_DNN/no_punct/best_model.pth"    # path to model with no punctuation
path_punctuation_features = "C:/Users/Jelena/git_repos/irony-detection/saves/TAR_models/CNN_LSTM_DNN/punct_features/best_model.pth"     # path to model with punctuation and feat
